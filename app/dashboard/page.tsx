          ...
          <div className="bg-white rounded-lg shadow-md mb-4 sm:mb-6 overflow-hidden">
            <div className="flex border-b overflow-x-auto scrollbar-hide">
              <button
                ...
                className={`flex-1 min-w-[120px] px-3 sm:px-4 py-3 sm:py-4 text-center font-semibold transition text-xs sm:text-sm whitespace-nowrap ${
                  activeTab === "pending"
                      ...
                      >
                        ...
                        <div className="hidden md:grid md:grid-cols-12 gap-4 px-4 lg:px-6 py-4 lg:py-5 items-center">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              >
                                <path
                                  ...
                                  strokeLinejoin="round"
                                  strokeWidth={2}
                                  d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 012-2h4a2 2 0 012 2v1m-4 4a2 2 0 002 2h.01M9 14a2 2 0 002 2h.01M9 18h6"
                                />
                              </svg>
                          ...
                          <div className="col-span-1 md:col-span-3 flex flex-col sm:flex-row gap-2 justify-end">
                            <button
                              onClick={() => handleRejectUser(user.id)}
                              className="px-4 py-2 bg-red-50 text-red-700 rounded-lg hover:bg-red-100 active:bg-red-200 font-semibold text-sm transition flex items-center justify-center gap-2 border border-red-200"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
                            ...
                            <button
                              onClick={() => handleApproveUser(user.id)}
                              className="px-4 py-2 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 active:bg-green-200 font-semibold text-sm transition flex items-center justify-center gap-2 border border-green-200"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
                          ...
                          <div className="p-4 sm:p-6 bg-blue-50 border-l-4 border-blue-500">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                              <button
                                ...
                                className="flex-1 sm:flex-initial px-4 sm:px-6 py-2 sm:py-2.5 bg-primary-600 text-white rounded-lg hover:bg-primary-700 active:bg-primary-800 font-semibold text-sm sm:text-base transition flex items-center justify-center gap-2"
                              >
                                <svg
                              ...
                              <button
                                ...
                                className="flex-1 sm:flex-initial px-4 sm:px-6 py-2 sm:py-2.5 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 active:bg-gray-400 font-semibold text-sm sm:text-base transition"
                              >
                                Cancel
                              </button>
                            </div>
                          ...
                          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                              ...
                              {order.client_imo_id && (
                                <div className="text-xs sm:text-sm text-gray-600 mt-1 flex flex-wrap items-center gap-2">
                                  ...
                                  <button
                                    ...
                                    className="px-2 py-1 text-xs bg-gray-100 hover:bg-gray-200 text-gray-700 rounded transition flex items-center gap-1 flex-shrink-0"
                                    title="Copy IMO ID"
                                  >
                                    <svg
                                      className="w-3 h-3"
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
                              <button
                                ...
                                className="flex-1 sm:flex-initial px-4 py-2 bg-red-50 text-red-700 rounded-lg hover:bg-red-100 active:bg-red-200 font-semibold text-sm transition flex items-center justify-center gap-2 border border-red-200"
                              >
                                <svg
                                  className="w-4 h-4"
                                  fill="none"
                              ...
                              <button
                                ...
                                className="flex-1 sm:flex-initial px-4 py-2 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 active:bg-green-200 font-semibold text-sm transition flex items-center justify-center gap-2 border border-green-200"
                              >
                                <svg
                                  className="w-4 h-4"
                                  fill="none"
